...
%\input{./sections/0LaTex_EXAMPLES}
\input{./sections/1AIM}
\input{./sections/2THEORETICAL_BACKGROUND} 
\input{./sections/3CALCULATIONS+RESULTS}
\input{./sections/4CONCLUSIONS} 
...
\bibliography{OrbitalMechanics} 

\appendix
\input{./sections/ApCODE}
\end{document}