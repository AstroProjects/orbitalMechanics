...
% ˜˜˜˜˜˜˜˜˜˜˜˜
%
% This program uses Algorithm 8.1 to compute the orbital
% elements and state vector of the earth at the date and time
% specified in Example 8.7. To obtain the same results for
% Mars, set planet_id = 4.
%
