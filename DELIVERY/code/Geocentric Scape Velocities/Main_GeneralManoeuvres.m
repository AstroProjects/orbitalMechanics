...
%--------------------------------------------------------------------------
fprintf('\nHyperbolic excees speed: %gkm/s' , v_inf)
fprintf('\nSpacecraft speed on parking orbit: %gkm/s', vc)
fprintf('\nDelta_v: %gkm/s',delta_v);
fprintf('\nPerigee of deparature hyperbola: %gkm',rp)
fprintf('\nbeta: %g', beta)
fprintf('\n\nSpcecraft fuel percent among total mass: %g\n',perc_mp)